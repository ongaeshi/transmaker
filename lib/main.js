...
exports.main = function(options, callbacks) {
  ...
  var textTranslatePanel = panel.Panel({
    ...
    onMessage: function(msg) {
      ...
      var toLang = (msg.to == "") ? locale.getMylang() : msg.to;
      
      bingTranlator.translateArray([msg.text], "", toLang, function(json) {
        var text = json.map(function(v){return v.TranslatedText;}).join(", ");
